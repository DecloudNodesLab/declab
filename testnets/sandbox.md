...
[Akash Network Sandbox EXPLORER](https://explorer.declab.pro/Akash_sandbox)|
|:--:|


## Endpoints

|[**RPC**](https://sandbox.declab.pro:26637)|[**API**](https://sandbox.declab.pro)|
|:--:|:--:|

**Genesis:** ```https://sandbox.declab.pro/genesis.json```

```
wget -O ~/.akash/config/genesis.json https://sandbox.declab.pro/genesis.json --inet4-only
```

**Addrbook:** ```https://sandbox.declab.pro/addrbook.json```

```
wget -O ~/.akash/config/addrbook.json https://sandbox.declab.pro/addrbook.json --inet4-only
```

**Peer:** ```73ef1c0f9bc77fd925decf7fa41f22a35b5dc76d@sandbox.declab.pro:26639```

```
PEERS=73ef1c0f9bc77fd925decf7fa41f22a35b5dc76d@sandbox.declab.pro:26639,064b1c1a295ca9b3a1360283086f61705525aeed@192.175.53.243:26656,b9751d5a8b3c2f242b5de21c3d5ff6440d8765cd@52.30.142.144:26656,f31426d9fb39c2d97653722a34b4c72db71904c2@93.115.25.106:29656,37201c92625df2814a55129f73f10ab6aa2edc35@95.214.53.215:26696,34aa700c44f35abe8319428f173503ea7faee3b7@144.76.56.87:28656
...
curl -o - -L https://sandbox.declab.pro/latest.tar.lz4 | lz4 -c -d - | tar -x -C ~/.akash
```

## State sync

```
RPC="https://sandbox.declab.pro:26637"
